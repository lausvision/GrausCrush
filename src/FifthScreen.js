...
class FifthScreen extends Component{
    ...
    async componentWillMount(){
      ...
      this.setState({imageURL: res.data.artObjects[6].webImage.url});
      this.setState({maker: res.data.artObjects[6].principalOrFirstMaker});
      this.setState({title: res.data.artObjects[6].title});
      this.setState({prodPlace: res.data.artObjects[6].productionPlaces[0]});
      this.setState({linktoweb: res.data.artObjects[6].links.web});
